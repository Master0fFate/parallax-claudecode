...
user-invocable: true
allowed-tools: mcp__plugin_parallax-claudecode_parallax__parallax_health, mcp__plugin_parallax-claudecode_parallax__parallax_trace_view
---

# Status

Call `parallax_health` with the current Claude session ID. Do not inspect or borrow another session.
